 ...
 */
package stream_and_lambda_expressions.streamslambdas.three.examples;
...
public class FunctionalInterfacesExample01 {
    ...
    public static void main(String[] args) {
        ...
        findProduct(products, product -> product.getName().equals(name))    //get Optional list of Products
                .map(Product::getPrice)    //transforms Optional product list to "singleton" price
                .ifPresentOrElse(    //method in Optional class
